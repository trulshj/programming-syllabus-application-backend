...
app.use(bodyparser.urlencoded({limit:'1000mb',extended:true,parameterLimit:'10000'}));
app.use(cors());
...
const sequlize = new Sequelize(process.env.DATABASE_NAME,process.env.DATABASE_USER,process.env.DATABASE_PASSWORD,{
